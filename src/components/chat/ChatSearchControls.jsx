...
export default function ChatSearchControls({
  ...
  return (
    <div className="flex items-center justify-between w-full h-12 gap-2.5">
      <button
        type="button"
        onClick={onOpenResults}
        disabled={disabled}
        className={`${controlSurfaceClass} max-w-[min(72vw,240px)] px-4 text-[15px] font-medium tabular-nums truncate`}
        aria-live="polite"
        aria-atomic="true"
      ...
      <div className="flex items-center gap-2 shrink-0">
        <button
          ...
          onClick={onPrev}
          disabled={disabled}
          className={`${controlSurfaceClass} w-12 shrink-0`}
