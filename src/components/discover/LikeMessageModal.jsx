    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="p-6">
        ...
        <textarea
          ...
          className="w-full px-4 py-3 bg-[var(--ios-fill-tertiary)] rounded-2xl border border-[var(--ios-hairline)] outline-none focus:border-blue-500 resize-none h-24 mb-4"
          maxLength={200}
        />
        <div className="flex gap-3">
          <button onClick={onClose} className="flex-1 py-3 bg-[var(--ios-fill-tertiary)] rounded-full">
            Cancel
          </button>
